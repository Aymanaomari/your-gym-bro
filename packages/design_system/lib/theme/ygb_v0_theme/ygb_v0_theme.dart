    ...
    return ThemeData(
      ...
      extensions: <ThemeExtension<dynamic>>[
        YGBV0ColorTheme(
          ...
          neutral100: const Color(0xFFF2F4F7),
          neutral200: const Color(0xFFE4E7EB),
          neutral300: const Color(0xFFD0D5DD),
          neutral400: const Color(0xFF98A2B3),
          neutral500: const Color(0xFF667085),
          neutral600: const Color(0xFF475467),
          neutral700: const Color(0xFF344054),
          neutral800: const Color(0xFF1D2939),
          neutral900: const Color(0xFF10161E),
          error: const Color(0xFFCC3300),
          warning: const Color(0xFFFF9F43),
          success: const Color(0xFF28C76F),
        ),
        YGBV0SpacingTheme(),
        YgbV0RadiusTheme(),
      ],
